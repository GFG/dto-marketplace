...
class ReadyToShipTest extends \PHPUnit_Framework_TestCase
{
    private $dw;
    private $context;
    ...
    public function setup()
    {
        ...
        $this->context = new ReadyToShip($this->dw);
    } 
    ...
    public function testExportContextData()
    {
        ...
        $exportedData       = [
            'name' => 'gfg.dtomarketplace.context.venture.postpayment.readytoship',
            'info' => $info,
