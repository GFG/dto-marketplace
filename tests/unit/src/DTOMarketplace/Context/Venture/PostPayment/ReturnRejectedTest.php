...
class ReturnRejectedTest extends \PHPUnit_Framework_TestCase
{
    private $dw;
    private $context;
    ...
    public function setup()
    {
        ...
        $this->context = new ReturnRejected($this->dw);
    } 
    ...
    public function testExportContextData()
    {
        ...
        $exportedData       = [
            'name' => 'gfg.dtomarketplace.context.venture.postpayment.returnrejected',
            'info' => $info,
