...
class IntermediateStatusTest extends \PHPUnit_Framework_TestCase
{
    private $dw;
    private $context;
    ...
    public function setup()
    {
        ...
        $this->context = new IntermediateStatus($this->dw);
    } 
    ...
    public function testExportContextData()
    {
        ...
        $exportedData       = [
            'name' => 'gfg.dtomarketplace.context.venture.postpayment.intermediatestatus',
            'info' => $info,
